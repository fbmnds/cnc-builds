    ...
    (let ((ret '((((2.5 . 0.0) . 2.0))
      ...
      (assert (equal ret
                     (mapcar #'convert-dxyz-
                             (insert-tags square (group-2 square) 2.5))))))
  ;; path tags w/2 dz nz
  ;;(format t "~a" (convert-path-dxyz square (group-2 square) 2.5 0.5 5))

  (let ((ret '(((2.5 . 0.0) . 0.0) ((5.0 . 0.0) . 0.0) ((2.5 . 0.0) . 0.0)
               ((0.0 . 2.5) . 0.0) ((0.0 . 5.0) . 0.0) ((0.0 . 2.5) . 0.0)
               ((-2.5 . 0.0) . 0.0) ((-5.0 . 0.0) . 0.0) ((-2.5 . 0.0) . 0.0)
               ((0.0 . -2.5) . 0.0) ((0.0 . -5.0) . 0.0) ((0.0 . -2.5) . 0.0)
